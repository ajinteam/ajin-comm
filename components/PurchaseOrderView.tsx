    ...
    return (
      <div className="space-y-6">
        ...
        <div className="py-4 md:py-8 bg-slate-200 min-h-screen overflow-x-auto overflow-y-auto">
          <div className="bg-white border-[1px] border-slate-200 shadow-2xl mx-auto p-4 md:p-12 min-h-[297mm] w-full max-w-[1600px] text-black font-gulim text-left overflow-x-auto animate-in slide-in-from-bottom-8 duration-500">
            <div className="min-w-[950px] xl:min-w-0 w-full">
              ...
              <table className={`w-full border-collapse border-black border-[1px] text-xs md:text-sm lg:text-[14px] select-none`}>
  ...
  if (activeItem) {
    ...
    return (
      <div className="py-8 bg-slate-200 min-h-screen">
        <div className="max-w-[1600px] w-full mx-auto mb-6 flex flex-wrap justify-between items-center px-4 no-print gap-4">
...
<div className="flex flex-wrap gap-3">
  ...
  <button onClick={handlePrint} className="bg-blue-600 text-white px-8 py-2.5 rounded-xl font-black shadow-lg hover:bg-blue-700 text-xs">
    PDF 저장 / 인쇄
        ...
        <div className="bg-white border-[1px] border-slate-200 shadow-2xl mx-auto p-4 md:p-12 min-h-[297mm] w-full max-w-[1600px] text-black font-gulim text-left overflow-x-auto document-print-content">
          <div className="min-w-[950px] xl:min-w-0 w-full">
            {isPOForm ? (
              <>
                {false ? (
                ...
                <table className={`w-full border-collapse border-black border-[1px] ${isPO1Active ? 'text-[15px]' : 'text-xs md:text-sm lg:text-[14px]'}`}>
