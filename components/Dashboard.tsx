    ...
    <div className="space-y-4 md:space-y-12 animate-in fade-in duration-700">
      ...
      <div className="space-y-6 md:space-y-12">
        ...
        <CategorySection title="발주서 현황" mainCat={MainCategory.PURCHASE}>
          ...
          <StatCard title="PO 결재완료" count={counts.purchase.approved} colorClass="indigo" statusLabel={PurchaseOrderSubCategory.APPROVED} onClick={() => setView({ type: 'PURCHASE', sub: PurchaseOrderSubCategory.APPROVED })} />
        </CategorySection>
